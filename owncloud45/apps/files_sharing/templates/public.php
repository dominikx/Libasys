...
<input type="hidden" id="publicTpl" value="1" />
<header><div id="header">
	<a href="<?php echo link_to('', 'index.php'); ?>" title="" id="owncloud"><img class="svg" src="<?php echo image_path('', 'logo_small.png'); ?>" alt="ownCloud" /></a>
...
<div id="publicFooter">
<footer><p class="info"><a href="http://owncloud.org/" target="_blank">ownCloud</a> &ndash; <?php echo $l->t('web services under your control'); ?><br />Theme by <a href="http://www.libasys.de" target="_blank">Libasys</a></p></footer>
</div>
</div>
