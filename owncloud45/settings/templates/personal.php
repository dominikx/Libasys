...
<div  class="personalblock">
    <legend>Geteilte Dateien und Ordner</legend>
      <ul class="shareSettings">
          <li style="background:#313131;"><span style="width:15%;">ShareType </span><span style="width:15%;">Name</span><span style="width:35%;">Share Item</span><span style="width:20%;">Expiration Date</span><br style="clear:both;" /></li> 
      <?php if(is_array($_['shares'])) {foreach($_['shares'] as $shareInfo):?>
            <li><span style="width:15%;"><?php echo $shareInfo['shareType']; ?> </span><span style="width:15%;"><?php echo $shareInfo['shareName']; ?> </span><span style="width:35%;"><a href="<?php echo $shareInfo['link']; ?>" target="_blank"><?php echo $shareInfo['name']; ?> </a> </span><span style="width:20%;"><?php echo $shareInfo['date']; ?></span><br style="clear:both;" /></li> 
